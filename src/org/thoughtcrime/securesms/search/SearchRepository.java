...
public class SearchRepository {
  ...
  public void query(@NonNull String query, @NonNull Callback callback) {
    executor.execute(() -> {
      ...
      conversations.add(new SearchResultInfo(null, query + ": Conversation 3", "Message text 3", "3:00pm", SearchResultInfo.Type.CONVERSATION));
      ...
      conversations.add(new SearchResultInfo(null, query + ": Contact 3", null, "work", SearchResultInfo.Type.CONTACT));
      ...
      conversations.add(new SearchResultInfo(null, query + ": Message 3", null, "3:01pm", SearchResultInfo.Type.MESSAGE));
